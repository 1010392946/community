...
public class ElasticsearchTest {
    ...
    public void testInsert(){
        discussRepository.save(discussMapper.selectDiscussPostById(297));
//        discussRepository.save(discussMapper.selectDiscussPostById(239));
//        discussRepository.save(discussMapper.selectDiscussPostById(240));
    }
        ...
        Page<DiscussPost> page = elasticsearchTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            ...
            public <T> AggregatedPage<T> mapResults(SearchResponse response, Class<T> aClass, Pageable pageable) {
                ...
                for (SearchHit hit : hits){
                    ...
                    String commwntCount = hit.getSourceAsMap().get("commentCount").toString();
                    post.setCommentCount(Integer.valueOf(commwntCount));
